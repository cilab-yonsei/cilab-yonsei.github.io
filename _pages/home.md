...
<!-- <div class="container-fluid d-none d-sm-block" style="text-align:center">
  <p><a href="https://docs.google.com/document/d/1XCMitnyXsAjFM89hU_FXIPsxlxdh0i0CM7t4_vQ9rxI/edit?usp=sharing"><img src="{{ site.url }}{{ site.baseurl }}/images/recruite/2026-1_YU_KIST.png" style="max-width: 100%"></a></p>
</div>
<br/> -->
    ...
    <div class="carousel-inner" markdown="0">
		...
		<div class="item">
          <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/ICRA2026_CHC.png" alt="Slide" />
            <div class="carousel-caption bg-dark mb-4">
              <h3>International Conference on Robotics and Automation (ICRA 2026)</h3>
              <p>PAGTM: Position and Attention-Guided Token Merging for Efficient Visual Place Recognition</p>
            </div>
        </div>
		...
		<div class="item">
          <img src="{{ site.url }}{{ site.baseurl }}/images/slider7001400/AAAI2026_JYJ.png" alt="Slide" />
            <div class="carousel-caption bg-dark mb-4">
              ...
              <p>A<sup>2</sup>LC: Active and Automated Label Correction for Semantic Segmentation</p>
            </div>
        </div>
